...
urlpatterns = [
    url(r'^admin/infolist/', admin.site.urls),
    #url(r'^$', views.home),
    url(r'^$', views.post_list_view),#with out slug
    ...
    url(r'^ct/', views.ContactPagveView),
    url(r'^infolist/admin/', views.Listview),
    url(r'^delete/(?P<id>\d+)/$', views.Delete_view),
                  url(r'^pf/', views.Postview),
